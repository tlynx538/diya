...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new Scaffold(
        appBar: new AppBar(title: new Text('Diya')),
        body: new Center(
          child: new Column(
              ...
              children: <Widget>[
                ...
                new RaisedButton(onPressed: () async => await Lamp.flash(new Duration(seconds: 540)), child:  new Text("Your torch will flash for 9 minutes!"))
              ]),
        ),
